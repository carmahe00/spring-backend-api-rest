...
INSERT INTO usuarios (username, password, enabled, nombre, apellido, email) VALUES ('andres','$2a$10$w1CHTpMczDVtvHTl0RtK8OW1Nlm0nl/n/8HI/llyxGX/7ZovDBpE6',1, 'Andres', 'Guzman','profesor@bolsadeideas.com');
INSERT INTO usuarios (username, password, enabled, nombre, apellido, email) VALUES ('admin','$2a$10$MPH8xLQ.VxhEqj9cDnLxO.ylh/F1U2grngWOQDRsqSs0Mr52L7Jye',1, 'John', 'Doe','jhon.doe@bolsadeideas.com');
